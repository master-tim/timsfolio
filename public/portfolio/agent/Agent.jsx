    ...
    >
      ...
      >
          ...
          >
            <span
              style={{
                ...
                boxShadow: "0 0 10px var(--a-accent)",
              }}
            />
        ...
        <div>
          ...
          <div style={{ display: "flex", flexDirection: "column", gap: 2 }}>
            {suggestions.map((s) => (
              ...
              >
                <span style={{ color: "var(--a-accent)", fontSize: 10 }}>
                  →
                </span>
                <span>{s.t}</span>
              </button>
        ...
        <div>
          ...
          <div
            style={{ fontSize: 11.5, lineHeight: 1.9, color: "var(--a-muted)" }}
          >
            <div>
              <span style={{ color: "var(--a-faint)" }}>role</span>{" "}
              <span style={{ float: "right", color: "var(--a-ink)" }}>
                {D.role}
              </span>
            </div>
            <div>
              <span style={{ color: "var(--a-faint)" }}>loc</span>{" "}
              <span style={{ float: "right", color: "var(--a-ink)" }}>
                {D.location}
              </span>
            </div>
            <div>
              <span style={{ color: "var(--a-faint)" }}>tz</span>{" "}
              <span style={{ float: "right", color: "var(--a-ink)" }}>
                {D.tz}
              </span>
            </div>
            ...
            <div>
              <span style={{ color: "var(--a-faint)" }}>up</span>{" "}
              <span style={{ float: "right", color: "var(--a-ink)" }}>
                {fmtUptime(uptime)}
              </span>
            </div>
        ...
        <div>
          ...
          >
            <a href={`mailto:${D.email}`} style={linkStyle}>
              → {D.email}
            </a>
            <a href={`https://github.com/${D.github}`} style={linkStyle}>
              → github/{D.github}
            </a>
            <a href={`https://linkedin.com/in/${D.linkedin}`} style={linkStyle}>
              → linkedin/{D.linkedin}
            </a>
          </div>
        </div>
...
function ThinkingLine() {
  ...
  return (
    <div style={{ color: "var(--a-muted)", padding: "6px 0" }}>
      ▍ thinking{dots}
    </div>
  );
}
...
function LogRow({ m }) {
  if (m.type === "system") {
    return (
      <div style={{ color: "var(--a-faint)", padding: "3px 0", fontSize: 12 }}>
        ※ {m.text}
      </div>
    );
  }
  if (m.type === "user") {
    return (
      <div style={{ padding: "10px 0 6px", fontSize: 14 }}>
      ...
      <div style={{ padding: "6px 0 12px" }}>
        ...
        >
          ...
          {m.status && (
            <span
              style={{
                color: m.status === "ok" ? "var(--a-accent)" : "#E0564B",
                fontSize: 10.5,
                letterSpacing: "0.04em",
                padding: "1px 6px",
    ...
    >
      <div
        style={{
          ...
          gap: 12,
          border:
            "1px solid " + (input.trim() ? "var(--a-accent)" : "var(--a-line)"),
      ...
      >
        ...
        <button
          ...
          style={{
            ...
            border:
              "1px solid " +
              (input.trim() ? "var(--a-accent)" : "var(--a-line)"),
            padding: "6px 14px",
            borderRadius: 2,
      ...
      >
        <span>
          ↑/↓ for history · tab to complete · free-form → claude-haiku fallback
        </span>
        <span>© 2026 td</span>
      </div>
    </form>
